    ...
    return (
        <Modal>
            <Button className={'border rounded-sm'}
                variant="ghost"><FaRegEdit />Edit</Button>
            <Modal.Backdrop>
                    ...
                    <Modal.Dialog className="sm:max-w-xl">
                        ...
                        <Modal.Body className="p-6">
                            <Surface variant="default">
                                <form action={handleEditDestination}
                                    className="space-y-8"
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        {/* Destination Name */}
                                        <div className="md:col-span-2">
                                            <TextField defaultValue={destinationName}
                                        ...
                                        {/* Country */}
                                        <TextField defaultValue={country}
                                        ...
                                        {/* Departure Date */}
                                        <div className="md:col-span-2">
                                            <TextField defaultValue={departureDate}
